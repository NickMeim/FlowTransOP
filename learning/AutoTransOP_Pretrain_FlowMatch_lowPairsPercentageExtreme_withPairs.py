...
parser.add_argument(
    "--checkpoint_dir",
    type=str,
    default="./chkpts_training_lowPairsPercentage_extreme_withPairs",
    help="Directory to store checkpoints and progress.json",
)
parser.add_argument(
    "--log_file",
    type=str,
    default="logs/FlowMatch_lowPairsPercentage_extreme_withPairs.log",
...
parser.add_argument(
    "--output_dir",
    type=str,
    default="../results/FlowMatch_extremely_fewPairs_A375_HT29_withPairs/",
...
for i, n_pairs in enumerate(args.n_pairs_list):
    ...
    for fold_id in range(model_params["no_folds"]):
        ...
        for rep in range(effective_repeats):
            ...
            (pearson_1_to_2, _, flow_12) = train_flowMatch_withpairs_fold(
                model_params,
                device,
                X_1,
                X_2,
