...
for folder in folders:
    ...
    for fold_id in range(1, 6):
        ...
        (pearson_1_to_2,cosine_train,flow_12) = train_flowMatch_fold(model_params, device,
                                                                     X_1,X_2,
                                                                     Z_1, Z_2,
                                                                     decoder_1, decoder_2,
                                                                     flow_12,
        ...
        df_result_1_translation.to_csv(output_dir+folder+'_flow12_TransAct_GeneralizedTransOP_translation_latent_dim30_eval.csv')
        ...
        df_result_latent.to_csv(output_dir+folder+'_flow12_TransAct_GeneralizedTransOP_latent_space_latent_dim30_eval.csv')
