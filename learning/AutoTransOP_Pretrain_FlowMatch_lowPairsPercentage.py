...
# Initialize argparse
parser = argparse.ArgumentParser(description="Run cross-fold validation for low pairs percentage.")
parser.add_argument('--checkpoint_dir', type=str, default='./chkpts_training_lowPairsPercentage',
                    help='Directory to store checkpoints and progress.json')
parser.add_argument('--log_file',type=str,default='logs/FlowMatch_lowPairsPercentage.log',help='Location of the log file that I can see print outputs')
...
parser.add_argument('--output_dir', type=str, help='Directory to save output results.',default='../results/FlowMatch_lowPairsPercentage/')
# Training parameters
