...
parser.add_argument('--checkpoint_dir', type=str, default='./paired_chkpts_training_lowPairsPercentage',
                    help='Directory to store checkpoints and progress.json')
parser.add_argument('--log_file',type=str,default='logs/Paired_FlowMatch_lowPairsPercentage.log',help='Location of the log file that I can see print outputs')
...
parser.add_argument('--output_dir', type=str, help='Directory to save output results.',default='../results/FlowMatch_lowPairsPercentage_withPairs/')
# Training parameters
...
for fi, folder in enumerate(folders):
    ...
    for fold_id in range(model_params['no_folds']):
        ...
        (pearson_1_to_2,_,flow_12) = train_flowMatch_withpairs_fold(model_params, device,
                                                          X_1,X_2,
                                                          Z_1, Z_2,
        ...
        (pearson_2_to_1,_,flow_21) = train_flowMatch_withpairs_fold(model_params, device,
                                                          X_1, X_2,
                                                          Z_1, Z_2,
                                                          all_emb1, all_emb2,trainInfo_1, trainInfo_2,trainInfo_paired,
                                                          encoder_1, encoder_2,
